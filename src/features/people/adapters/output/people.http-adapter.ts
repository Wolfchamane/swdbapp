import type { PeopleHttpClient, PeopleModel, PeopleListOutput } from '@swdbapp/infra-http-swapi';
import type {PeopleDescribePortInput, PeopleListPortInput, PeopleListPortOutput, PeoplePorts} from '../../application';
import type { People } from "../../types";

export class PeopleHttpAdapter
    implements PeoplePorts {
