<script lang="ts" setup>
	...
	import { faCircleLeft, faGear, faCircleInfo, faCircleXmark } from '@fortawesome/free-solid-svg-icons';
...
<template>
    ...
    <transition name='slide'>
        <div class='app-license d-flex flex-column p-absolute top-0 left-0 z-1 w-100 h-100 m-1 p-1 radius-m bg-color-background color-foreground' v-show='showLicense'>
            <font-awesome-icon :icon='faCircleXmark' @click='toggleLicense' class="cursor-pointer" style='align-self: end'/>
