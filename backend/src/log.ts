...
export const log = (message: string, ...args: any[]): void =>
    _traceMessage('LOG', message, ...args);

export const error = (message: string, ...args: any[]): void =>
    _traceMessage('ERR', message, ...args);

export const warning = (message: string, ...args: any[]): void =>
    _traceMessage('WAR', message, ...args);

export const debug = (message: string, ...args: any[]): void =>
    _traceMessage('DEB', message, ...args);

export const info = (message: string, ...args: any[]): void =>
    _traceMessage('INF', message, ...args);
